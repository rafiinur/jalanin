...
export default function ModalHiling() {
	...
	const [hasil, setHasil] = useState<{ sisa: number; waktu: number } | null>(
		null
	);
	...
	return (
		<main className="min-h-screen px-6 py-10" style={{ background: "#FFF1E7" }}>
			...
			<section className="grid max-w-6xl gap-10 mx-auto mb-16 md:grid-cols-2">
						...
						<div className="w-9 h-9 flex items-center justify-center rounded-full bg-[#FFB877]">
							<svg width="20" height="20" fill="none" viewBox="0 0 24 24">
								...
								<rect
									...
									fill="#FFB877"
								/>
								<rect x="8" y="6" width="8" height="3" rx="1" fill="#fff" />
								<rect x="8" y="10" width="3" height="3" rx="1" fill="#fff" />
								<rect x="13" y="10" width="3" height="3" rx="1" fill="#fff" />
								<rect x="8" y="15" width="3" height="3" rx="1" fill="#fff" />
								<rect x="13" y="15" width="3" height="3" rx="1" fill="#fff" />
							</svg>
						</div>
						<h2 className="font-bold text-lg text-[#FF914D]">
							Kalkulator Tabungan
						</h2>
					</div>
					<div className="w-full max-w-lg mx-auto space-y-6">
						<div>
							<label className="block w-full mb-1 text-sm font-bold text-left text-neutral-700">
								Tabungan per bulan
							</label>
							<input
								type="number"
						...
						<button
							...
							className="w-full py-3 text-base font-semibold text-white rounded-lg shadow"
							style={{
              ...
              `}
						>
							...
							<div className="flex justify-between mb-3 text-sm">
								...
								<span>
									{parseInt(tabunganSaatIni) >= daftarPaket[paket].harga
										? "-"
										: hasil.waktu >= 12
										? `${Math.floor(hasil.waktu / 12)} tahun ${
												hasil.waktu % 12
										  } bulan`
										: `${hasil.waktu} bulan`}
								</span>
							...
							{parseInt(tabunganSaatIni) >= daftarPaket[paket].harga && (
								<div className="flex items-center gap-2 mt-4 text-sm font-semibold text-green-700">
									<svg width="18" height="18" fill="none" viewBox="0 0 24 24">
					...
					<div className="flex items-center gap-3 mb-6">
						<div className="w-9 h-9 flex items-center justify-center rounded-full bg-[#FFB877]">
							<svg width="20" height="20" fill="none" viewBox="0 0 24 24">
								<rect width="24" height="24" rx="6" fill="#fff" />
								<path
									d="M6 10l6-4 6 4v6a2 2 0 01-2 2H8a2 2 0 01-2-2v-6z"
									fill="#FFB877"
								/>
								<path
									d="M6 10l6 4 6-4"
								...
								>
									<div className="relative w-full">
										<Image
											...
											onError={(e) =>
												(e.currentTarget.src =
													"https://placehold.co/340x112?text=No+Image")
											}
										/>
									...
									<div className="flex flex-col gap-1 p-3 text-left items-left">
										<h3 className="text-base font-bold text-neutral-900">
											{p.nama}
										</h3>
										<div className="mb-1 text-xs text-gray-500">
											Destinations: Denpasar, Ubud, Kintamani, Uluwatu, Gili
											Trawangan
										</div>
										<div className="flex flex-wrap gap-2 mb-1 text-xs text-gray-600 items-left justify-left">
											<span className="flex gap-1 items-left">
												<svg
													width="14"
													height="14"
													fill="none"
											...
											<span className="flex gap-1 items-left">
												...
												>
													...
													/>
													<path
														d="M2 20v-1a4 4 0 014-4h4a4 4 0 014 4v1"
														stroke="#FF914D"
														strokeWidth="2"
													/>
													<path
														d="M14 20v-1a4 4 0 014-4h0a4 4 0 014 4v1"
														stroke="#FF914D"
														strokeWidth="2"
													/>
												</svg>
			...
			<section className="bg-white max-w-6xl mx-auto px-10 py-20 min-h-[420px] rounded-2xl text-center shadow-lg border border-orange-100 mb-10">
				<h2 className="text-[#FF914D] font-extrabold text-2xl md:text-3xl mb-10 tracking-tight">
					Kenapa Pilih Modal Hiling??
				</h2>
				<div className="flex flex-col justify-center gap-8 md:flex-row">
					<div className="bg-[#FFB87733] p-8 rounded-xl flex-1 mx-2 flex flex-col items-center transition-all duration-200 hover:-translate-y-1 hover:shadow-xl cursor-pointer">
						...
						<h3 className="font-bold text-lg mb-2 text-[#FF914D]">
							Simulasi Akurat
						</h3>
						<p className="text-base text-gray-600">
							Perhitungan yang tepat untuk mencapai target tabunganmu
						</p>
					</div>
					<div className="bg-[#FFB87733] p-8 rounded-xl flex-1 mx-2 flex flex-col items-center transition-all duration-200 hover:-translate-y-1 hover:shadow-xl cursor-pointer">
						<div className="w-12 h-12 flex items-center justify-center rounded-full bg-[#FFB877] mb-4">
						...
						<p className="text-base text-gray-600">
							Interface yang intuitif untuk merencanakan masa depan finansial
						</p>
					</div>
					<div className="bg-[#FFB87733] p-8 rounded-xl flex-1 mx-2 flex flex-col items-center transition-all duration-200 hover:-translate-y-1 hover:shadow-xl cursor-pointer">
						<div className="w-12 h-12 flex items-center justify-center rounded-full bg-[#FFB877] mb-4">
						...
						<p className="text-base text-gray-600">
							Berbagai pilihan paket sesuai kebutuhan dan kemampuan
						</p>
					</div>
				</div>
			</section>
