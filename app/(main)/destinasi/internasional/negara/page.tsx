...
const PaketNegaraPage = () => {
  return (
    <>
      <Head>
        <title>Paket Tour Internasional Jepang</title>
      ...
      <main className="bg-slate-50">
        <div className="container px-4 py-8 mx-auto">
          ...
          <div className="relative w-full mb-8 overflow-hidden h-96 rounded-2xl">
            <Image
              src="https://images.unsplash.com/photo-1573910393273-e7a177d1a21f?w=1200&q=80"
            ...
            <div className="absolute inset-0 z-10 flex flex-col items-center justify-center p-4 text-center bg-black bg-opacity-50">
              <h1 className="mb-4 text-4xl font-bold text-white md:text-5xl">
                Paket Tour Internasional Jepang
              </h1>
...
export default PaketNegaraPage;
