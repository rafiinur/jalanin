...
const DomesticDestinationPage = () => {
  return (
    <>
      {/* Hero Section */}
      <div className="relative flex flex-col justify-center items-center text-center min-h-screen bg-gradient-to-b from-primary-100 to-white">
        {/* Decorative Images */}
        <Image
          src="/megamendung-2.svg"
          alt="megamendung"
          width={296}
          height={197}
        ...
        <div className="relative z-10 container mx-auto flex flex-col items-center">
          ...
          <div className="mb-8 lg:mb-12">
            <h2 className="text-5xl font-semibold text-primary mb-2 leading-tight">
      ...
      <div className="container mx-auto flex flex-col my-20">
        <div className="relative py-28">
          <div className="absolute right-1/4 -z-20 size-80 bg-primary rounded-full blur-[150px]"></div>
          ...
          <Carousel className="max-w-5xl">
            ...
            <CarouselPrevious className="absolute left-0 top-1/2 transform -translate-y-1/2 bg-primary shadow-lg border-0" />
            <CarouselNext className="absolute right-0 top-1/2 transform -translate-y-1/2 bg-primary shadow-lg border-0" />
          </Carousel>
...
export default DomesticDestinationPage;
